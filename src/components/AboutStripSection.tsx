...
export default function AboutStripSection({ darkMode }: AboutStripSectionProps) {
  ...
  return (
    <section
      ...
      className={`pt-4 pb-12 md:pb-16 transition-colors duration-500 overflow-hidden relative ${darkMode ? 'bg-[#1b101e] text-white border-b border-white/5' : 'bg-[#faf7f0] text-primary'
        }`}
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
          ...
          <div className="w-full md:w-[65%] text-left">
            ...
            {t.para2 && (
              <p className={`font-sans text-xs md:text-sm leading-relaxed mb-6 ${darkMode ? 'text-white/70' : 'text-black/80'
                }`}>
                {t.para2}
              </p>
            )}
