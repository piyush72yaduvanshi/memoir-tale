...
function GalleryCard({ item, onClick, index, labelInspect }: { item: any; onClick: () => void; index: number; labelInspect: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#190F26]/95 via-[#190F26]/75 to-[#8B5CF6]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-5">
        <div className="flex justify-between items-start">
          <span className="text-[10px] uppercase tracking-widest text-[#8B5CF6] font-mono font-bold bg-[#8B5CF6]/10 border border-[#8B5CF6]/30 px-2 py-1 rounded">
            {item.type}
          </span>
          <div className="bg-[#8B5CF6] p-2 rounded-full text-[#190F26] shadow-lg transform translate-y-[-10px] group-hover:translate-y-0 transition-transform duration-350 ease-out">
        ...
        <div className="text-left transform translate-y-4 group-hover:translate-y-0 transition-transform duration-350 ease-out">
          ...
          <div className="w-12 h-[2px] bg-[#8B5CF6] mt-3 rounded" />
        </div>
      </div>
    </div>
  );
...
export default function GallerySection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[10%] right-[-80px] w-80 h-80 bg-[#8B5CF6]/4 rounded-full blur-[80px] pointer-events-none" />
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-5 py-2.5 rounded-full font-sans text-xs font-bold tracking-wide transition-all duration-300 cursor-pointer ${
                  activeCategory === cat.id
                    ? "bg-[#8B5CF6] text-[#190F26] shadow-[0_4px_20px_rgba(139, 92, 246,0.25)] scale-105"
            ...
            <div className="relative max-w-4xl w-full flex flex-col items-center">
              ...
              >
                <button
                  ...
                  className="px-5 py-2.5 bg-[#8B5CF6] hover:bg-amber-600 text-[#190F26] font-sans font-bold text-xs rounded-full transition-all duration-200 cursor-pointer shadow-[0_4px_16px_rgba(139, 92, 246,0.3)] flex items-center space-x-1.5 hover:scale-105 active:scale-95 outline-none focus:outline-none"
                >
              ...
              <div 
                onClick={(e) => e.stopPropagation()}
                className="w-full max-w-xl mt-5 p-5 sm:p-6 bg-[#190F26] border border-[#8B5CF6]/30 rounded-2xl text-left shadow-2xl mx-auto select-none"
              >
